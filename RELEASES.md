...
Version 0.10.1 (2025-10-11)
========================
* 视觉调整："最高定速"颜色、"速度限速"位置提高5px
* 视觉调整：绿灯和前车驶离提醒的字体改大




Version 0.10.1 (2025-10-10)
========================
* 同步master更新，优化参数
* #1390、#1310两个更新暂时未合并（C3会显示nopanda）
* 添加转向提示、更换停车计时样式



Version 0.10.1 (2025-10-09)
========================
* 同步master更新
* #1390、#1310两个更新暂时未合并（C3会显示nopanda）
...
Version 0.10.1 (2025-10-08)
========================
* 修复绿灯和前车驶离，静音模式也能播放
* 同步sp#1330、#1304、#1324、#1325更新
* 同步#1250更新特斯拉部分，支持读取车辆限速信息
* #1290、#1310两个更新暂时未合并（C3会显示nopanda）


Version 0.10.1 (2025-10-06)
========================
* 合并SP#1326更新（亮度菜单调整到 屏幕设置 中）
* 修改亮度调整按5%进行（原为10%）
* 设置模式按钮放置在设置页顶端
* 白色限速背景调70%透明度
* 绿灯和前车驶离提醒（如果打开），静音模式也能播放

Version 0.10.1 (2025-10-05)
========================
* 合并 2025-10-05 SP master 的更新
* #1390、#1310两个更新暂时未合并（C3会显示nopanda）
* 大部分内容汉化
* 右上角方向盘同步转动
* 增加道路边缘检测
